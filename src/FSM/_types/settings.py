...
class AutoPlaceSettings:
    coal: AutoPlace = field(default_factory=lambda: {"frequency": 1, "size": 1, "richness": 1})
    stone: AutoPlace = field(default_factory=lambda: {"frequency": 1, "size": 1, "richness": 1})
    copper_ore: AutoPlace = field(default_factory=lambda: {"frequency": 1, "size": 1, "richness": 1})
    iron_ore: AutoPlace = field(default_factory=lambda: {"frequency": 1, "size": 1, "richness": 1})
    uranium_ore: AutoPlace = field(default_factory=lambda: {"frequency": 1, "size": 1, "richness": 1})
    crude_oil: AutoPlace = field(default_factory=lambda: {"frequency": 1, "size": 1, "richness": 1})
    trees: AutoPlace = field(default_factory=lambda: {"frequency": 1, "size": 1, "richness": 1})
    enemy_base: AutoPlace = field(default_factory=lambda: {"frequency": 1, "size": 1, "richness": 1})
...
class MapGenerationSettings:
    ...
    starting_points: Coordinates = field(default_factory=lambda: {"x": 0, "y": 0})
    seed: int | None = None
